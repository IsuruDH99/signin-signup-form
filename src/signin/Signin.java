...
public class Signin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 30, 120, 50));

        jsign_in_.setBackground(new java.awt.Color(51, 51, 255));
        ...
        jPanel1.add(jsign_in_, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 270, 130, -1));

        jLabelsignup.setBackground(new java.awt.Color(255, 255, 255));
        jLabelsignup.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        jLabelsignup.setText("Create An Account ");
        ...
        jPanel1.add(jLabelsignup, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 320, 260, 50));

        jpassword.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jPanel1.add(jpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 200, 245, 40));

        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\DELL\\Downloads\\pexels-pixabay-268415.jpg")); // NOI18N
